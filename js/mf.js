!function(t, e) {
    ...
    "function" == typeof define && define.amd ? define(e) : (t || self).MouseFollower = e();
}(this, function() {
    var t = /*#__PURE__*/function() {
        ...
        e.bind = function() {
            ...
            this.event.mouseleave = function() { return t.hide() };
            this.event.mouseenter = function() { return t.show() };
            this.event.mousedown = function() { return t.addState(t.options.activeState) };
            this.event.mouseup = function() { return t.removeState(t.options.activeState) };
            this.event.mousemoveOnce = function() { return t.show() };
            ...
            this.event.mouseover = function(e) {
                for (var i = e.target; i && i !== t.container && (!e.relatedTarget || !i.contains(e.relatedTarget)); i = i.parentNode) {
                    for (var s in t.options.stateDetection) {
                        if (i.matches(t.options.stateDetection[s])) {
                            t.addState(s);
                        }
                    }
        ...
        e.render = function(t) {
            if (!0 === t || 0 !== this.vel.y && 0 !== this.vel.x) {
                if (this.trigger("render"), this.setter.wc("transform"), this.setter.x(this.pos.x), this.setter.y(this.pos.y), this.skewing) {
                    ...
                    var i = Math.min(e * this.options.skewingDelta, this.options.skewingDeltaMax) * this.skewing;
                    var s = 180 * Math.atan2(this.vel.y, this.vel.x) / Math.PI;
        ...
        e.setStick = function(t) {
            ...
            this.stick = { y: i.top + i.height / 2, x: i.left + i.width / 2 };
        };
