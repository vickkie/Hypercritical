                ...
                <Table sx={{ minWidth: 650 }} aria-label="data table">
                  <TableHead className={Styles.tableheader}>
                    <TableRow className="table-header">
                      <TableCell className={Styles.headcellStyle}>Name</TableCell>
                      <TableCell className={Styles.headcellStyle}>Email</TableCell>
                      <TableCell className={Styles.headcellStyle}>Budget</TableCell>
                      ...
                      <TableCell className={Styles.headcellStyle}>Message</TableCell>
                      <TableCell className={Styles.headcellStyle}>Status</TableCell>
                      <TableCell className={Styles.headcellStyle}>Action</TableCell>
                    </TableRow>
                  </TableHead>
